...
INSTALL_PKGS="xfce4 xfce4-goodies gnome-icon-theme sudo vnc4server htop tigervnc-common vim zip unzip file-roller gedit xfonts-base neofetch dbus-x11 git wget build-essential fakeroot libncurses5-dev libssl-dev ccache bison flex qtbase5-dev bc rsync kmod cpio libelf-dev llvm clang lld"
